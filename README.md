# DEI Survey Analysis (SQL)
This project demonstrates how raw DEI survey data can be cleaned, validated, and analyzed using SQL.  
The analysis explores how different aspects of DEI perceptions vary alongside overall satisfaction with workplace culture.

## Data Overview
- Sample DEI survey dataset representing ~1,000 employees  
...
## Project Goal
To examine how employees’ perceptions of different DEI dimensions (e.g., fair treatment, workforce diversity, comfort of speech) vary across levels of overall satisfaction with workplace culture.
